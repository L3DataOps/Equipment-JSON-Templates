...
// File path
const filePath = "./results/microwave.json";
...
const options = [
  "Add Microwave from selected site to other site",
  "Add Edgelink",
  "Add Service Shelf"
];
//==================================================================================
...
/*
      {
        ...
        "equipmentName": "SiteName Edgelink Mux",
    ...
    },
    {
        ...
        "caseType": "Ticket",
        "siteid": { "$oid": "Enter ObjectID from MongoDB Here" }, 
        "equipmentName": "SiteName Microwave X to SiteName",
        "equipmentID": "Enter AMMS equipment number here",
        "additionalInfo": "",
        "serialNumber": "",
        "make": "Manufacturer",
    ...
    },
    {
        ...
        "caseType": "Ticket",
        "siteid": { "$oid": "Enter ObjectID from MongoDB Here" }, 
        "equipmentName": "SiteName Service Shelf",
        "equipmentID": "Enter AMMS equipment number here",
        "additionalInfo": "",
        "defaultVendor": { "$oid": "Enter ObjectID from MongoDB Here" },
        "lastEditedBy":{ "$oid": "Enter ObjectID from MongoDB Here" },
...
switch (userSelect) {
  case "1":{
    ...
    const collection = "Microwave";

    const num = prompt("Enter the # Microwave: ").trim();
    const toSite = prompt("Enter the site name the microwave is pointing to: ")
    const equipmentName = `${siteName} Microwave ${num} to ${toSite}`;
    const equipmentID = `${siteEQ}M${num}`;
    ...
    const serialNumber = prompt("Enter the serial number for the microwave:")
    const partNumber = prompt("Enter the part number:")
...
Object.keys(newEntry).forEach(key => {
  ...
  case "2":{
    ...
    const num = prompt("Enter the # for the Edgelink mux: ").trim();
    const toSite = prompt("Enter the site name the microwave is pointing to: ")
    const equipmentName = `${siteName} Edgelink Mux ${num} to ${toSite}`;
    const equipmentID = `${siteEQ}ME${num}`;
    ...
    const partNumber = prompt("Enter the part number:")
    const make = prompt("Enter the manufacturer:")
    const hostname = prompt("Enter the hostname for the eedgelink:")
...
Object.keys(newEntry).forEach(key => {
  ...
  break}
  case "3":{
    const type = "Service Shelf";
    const caseType = "Ticket";
    const collection = "Microwave";

    const num = prompt("Enter the # for the service shelf: ").trim();
    const equipmentName = `${siteName} Microwave Service Shelf ${num}`;
    const equipmentID = `${siteEQ}MMSS${num}`;
    ...
    const hostname = prompt("Enter the hostname for the MSS:")
    const ipAddress = prompt("Enter the IP Address: ")
    const reserveField1 = "";
    const reserveField2 = "";
    const reserveField3 = "";
